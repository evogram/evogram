...
export class PollAnswerContext extends Context<IPollAnswer> {
	...
	public user = this.client.contexts.getContext<UserContext>("User", this.source.user);
	/** Gets the ID of the poll. */
	public get id() { return this.source.poll_id }
	/** Gets the IDs of the options selected by the user. */
	public get options() { return this.source.option_ids }
}